...
This leads to our **agreement measure** (Appendix A.3.1):
...
where $\lambda$ is a probability distribution over contexts. The optimal weighting $\lambda^\star$ identifies which contexts create the worst contradictions—they receive the highest weights in the sum. (see Appendix A.3)