...
**Without A2** there is no continuous path toward resolution—contradiction either suddenly appears, or doesn't exist at all (Appendix B.3.4). It's like saying war either is happening or it's not—and that there was never any in-between.