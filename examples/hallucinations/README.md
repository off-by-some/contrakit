...
The sigmoid reveals three distinct phases. From 10% to 30% defined, hallucination jumps roughly 32 percentage points—the steepest region of the curve (51.9% to 84.1%). From 30% to 70% defined, increases continue at about 14 percentage points across 40 percentage points of training composition (84.1% to 98.3%). From 70% to 90%, slight decrease appears with about 4 percentage points (98.3% to 94.3%). By 30% defined composition, hallucination already reaches approximately 84%, and adding more defined data continues to increase hallucination significantly.
